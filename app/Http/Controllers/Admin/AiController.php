...
class AiController extends Controller
{
    public function index()
    {
        ...
        return view('admin.ais.index', compact('ais'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.ais.create', compact('campaigns', 'landing_pages'));
    }
    ...
    public function store(StoreAiRequest $request)
    {
        ...
        return redirect()->route('admin.ais.index');
    }
    ...
    public function edit(Ai $ai)
    {
        ...
        return view('admin.ais.edit', compact('ai', 'campaigns', 'landing_pages'));
    }
    ...
    public function show(Ai $ai)
    {
        ...
        return view('admin.ais.show', compact('ai'));
    }
