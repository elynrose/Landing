...
class QuizAnswersController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.quizAnswers.index', compact('quizAnswers'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.quizAnswers.create', compact('emails', 'quizzes'));
    }
    ...
    public function store(StoreQuizAnswerRequest $request)
    {
        ...
        return redirect()->route('frontend.quiz-answers.index');
    }
    ...
    public function edit(QuizAnswer $quizAnswer)
    {
        ...
        return view('frontend.quizAnswers.edit', compact('emails', 'quizAnswer', 'quizzes'));
    }
    ...
    public function show(QuizAnswer $quizAnswer)
    {
        ...
        return view('frontend.quizAnswers.show', compact('quizAnswer'));
    }
