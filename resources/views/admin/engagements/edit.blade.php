...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.engagements.update", [$engagement->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_encode') ? 'is-invalid' : '' }}" type="text" name="email_encode" id="email_encode" value="{{ old('email_encode', $engagement->email_encode) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('open') ? 'is-invalid' : '' }}" type="number" name="open" id="open" value="{{ old('open', $engagement->open) }}" step="1">
                @if($errors->has('open'))
                    <div class="invalid-feedback">
                        {{ $errors->first('open') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('click') ? 'is-invalid' : '' }}" type="number" name="click" id="click" value="{{ old('click', $engagement->click) }}" step="1">
                @if($errors->has('click'))
                    <div class="invalid-feedback">
                        {{ $errors->first('click') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ip_address') ? 'is-invalid' : '' }}" type="text" name="ip_address" id="ip_address" value="{{ old('ip_address', $engagement->ip_address) }}" required>
