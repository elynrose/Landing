    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.landing-pages.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('introduction') ? 'is-invalid' : '' }}" name="introduction" id="introduction" required>{{ old('introduction') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('confirmation_message') ? 'is-invalid' : '' }}" name="confirmation_message" id="confirmation_message">{{ old('confirmation_message') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('countdown') ? 'is-invalid' : '' }}" type="text" name="countdown" id="countdown" value="{{ old('countdown') }}">
