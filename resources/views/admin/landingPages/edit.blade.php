    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.landing-pages.update", [$landingPage->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discord') ? 'is-invalid' : '' }}" type="text" name="discord" id="discord" value="{{ old('discord', $landingPage->discord) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('countdown') ? 'is-invalid' : '' }}" type="text" name="countdown" id="countdown" value="{{ old('countdown', $landingPage->countdown) }}">
