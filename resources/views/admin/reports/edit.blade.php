    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reports.update", [$report->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_sent') ? 'is-invalid' : '' }}" type="number" name="total_sent" id="total_sent" value="{{ old('total_sent', $report->total_sent) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_delivered') ? 'is-invalid' : '' }}" type="number" name="total_delivered" id="total_delivered" value="{{ old('total_delivered', $report->total_delivered) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_bounced') ? 'is-invalid' : '' }}" type="number" name="total_bounced" id="total_bounced" value="{{ old('total_bounced', $report->total_bounced) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('opens') ? 'is-invalid' : '' }}" type="number" name="opens" id="opens" value="{{ old('opens', $report->opens) }}" step="1">
                @if($errors->has('opens'))
                    <div class="invalid-feedback">
                        {{ $errors->first('opens') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('clicks') ? 'is-invalid' : '' }}" type="number" name="clicks" id="clicks" value="{{ old('clicks', $report->clicks) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ip_address') ? 'is-invalid' : '' }}" type="text" name="ip_address" id="ip_address" value="{{ old('ip_address', $report->ip_address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unique_clicks') ? 'is-invalid' : '' }}" type="number" name="unique_clicks" id="unique_clicks" value="{{ old('unique_clicks', $report->unique_clicks) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unique_opens') ? 'is-invalid' : '' }}" type="number" name="unique_opens" id="unique_opens" value="{{ old('unique_opens', $report->unique_opens) }}" step="1">
