    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.trackings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_sent') ? 'is-invalid' : '' }}" type="number" name="total_sent" id="total_sent" value="{{ old('total_sent', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_delivered') ? 'is-invalid' : '' }}" type="number" name="total_delivered" id="total_delivered" value="{{ old('total_delivered', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_bounced') ? 'is-invalid' : '' }}" type="number" name="total_bounced" id="total_bounced" value="{{ old('total_bounced', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('opens') ? 'is-invalid' : '' }}" type="number" name="opens" id="opens" value="{{ old('opens', '') }}" step="1">
                @if($errors->has('opens'))
                    <div class="invalid-feedback">
                        {{ $errors->first('opens') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unique_clicks') ? 'is-invalid' : '' }}" type="number" name="unique_clicks" id="unique_clicks" value="{{ old('unique_clicks', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unique_opens') ? 'is-invalid' : '' }}" type="number" name="unique_opens" id="unique_opens" value="{{ old('unique_opens', '') }}" step="1">
