    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.engagements.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email_encode" id="email_encode" value="{{ old('email_encode', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="open" id="open" value="{{ old('open', '') }}" step="1">
                            @if($errors->has('open'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('open') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="click" id="click" value="{{ old('click', '') }}" step="1">
                            @if($errors->has('click'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('click') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ip_address" id="ip_address" value="{{ old('ip_address', '') }}" required>
