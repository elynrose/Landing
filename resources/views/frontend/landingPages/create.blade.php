                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.landing-pages.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="introduction" id="introduction" required>{{ old('introduction') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="confirmation_message" id="confirmation_message">{{ old('confirmation_message') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="countdown" id="countdown" value="{{ old('countdown') }}">
