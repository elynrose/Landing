                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.landing-pages.update", [$landingPage->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $landingPage->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="heading" id="heading" value="{{ old('heading', $landingPage->heading) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sub_heading" id="sub_heading" value="{{ old('sub_heading', $landingPage->sub_heading) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="introduction" id="introduction" required>{{ old('introduction', $landingPage->introduction) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="confirmation_message" id="confirmation_message">{{ old('confirmation_message', $landingPage->confirmation_message) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="about" id="about">{{ old('about', $landingPage->about) }}</textarea>
                            @if($errors->has('about'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('about') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="facebook" id="facebook" value="{{ old('facebook', $landingPage->facebook) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="twitter" id="twitter" value="{{ old('twitter', $landingPage->twitter) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="linkedin" id="linkedin" value="{{ old('linkedin', $landingPage->linkedin) }}">
